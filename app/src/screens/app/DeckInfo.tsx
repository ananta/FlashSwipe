    ...
    <Card theme='dark' elevate size='$3' bordered {...props}>
      <Card.Header padded>
        ...
        <Paragraph theme='alt2'>
          A basic description of deck #1 goes here
        </Paragraph>
      </Card.Header>
      <Card.Footer padded>
        <XStack f={1} />
        <Button br='$10' onPress={() => props.navigation.navigate('AddDeck')}>
          Start Swiping
        </Button>
      </Card.Footer>
    </Card>
...
type DeckCardProp = CardProps & DeckProp;

const DeckInfoScreen: React.FC<NavProps> = ({ navigation }) => {
  return (
    <YStack>
      ...
      <XStack $sm={{ flexDirection: 'column' }} space>
        <View style={{ height: '74%' }}>
          <FlatList
            data={[
              { title: 'card1', description: 'Deck 1 description' },
              { title: 'card2', description: 'Deck 2 description' },
              { title: 'card3', description: 'Deck 3 description' },
              { title: 'card4', description: 'Deck 3 description' },
              { title: 'card5', description: 'Deck 3 description' },
              { title: 'card6', description: 'Deck 3 description' },
              { title: 'card6', description: 'Deck 3 description' },
            ]}
